// Fixture-only config for the lint verification harness (`pnpm lint:fixtures`).
// It mirrors oxlint.config.ts except that fixture files are linted instead of ignored.
// tests/lint-config.test.ts asserts the rules and plugins stay in sync.
