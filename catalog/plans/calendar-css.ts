...
.aha-cal { max-width: 100%; container-type: inline-size; }
...
.aha-cal .cal-grid td.day { vertical-align: top; height: 4.5rem; padding: 0.25rem 0.375rem 0.375rem; border-bottom: 1px solid var(--hair); border-right: 1px solid var(--hair); overflow: hidden; }
